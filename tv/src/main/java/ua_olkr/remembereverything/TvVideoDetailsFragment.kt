...
package ua_olkr.remembereverything
 ...
 */
class TvVideoDetailsFragment : DetailsFragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mSelectedMovie = activity.intent.getSerializableExtra(TvDetailsActivity.MOVIE) as Movie
    ...
    private fun setupDetailsOverviewRowPresenter() {
        ...
        sharedElementHelper.setSharedElementEnterTransition(
                activity, TvDetailsActivity.SHARED_ELEMENT_NAME)
        ...
        detailsPresenter.onActionClickedListener = OnActionClickedListener { action ->
            if (action.id == ACTION_WATCH_TRAILER) {
                ...
                intent.putExtra(TvDetailsActivity.MOVIE, mSelectedMovie)
                startActivity(intent)
            } else {
    ...
    companion object {
        private val TAG = "TvVideoDetailsFragment"
